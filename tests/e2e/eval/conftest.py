...
Lives one level deeper than `tests/e2e/conftest.py` so it
...
from tests.e2e.eval._artifacts import RunArtifacts
...
def paperless_scope(paperless, scope):  # noqa: F811 — intentional override
    ...
    them.
    """
    from tests.e2e.paperless import cleanup_prefix
