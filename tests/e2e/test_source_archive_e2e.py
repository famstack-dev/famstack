...
Run with `-s` to stream the BDD narration:
    ...
    uv run --extra test pytest -s tests/e2e/test_source_archive_e2e.py
"""
...
from tests.e2e.openai_stub import stub_classify, stub_reformat
...
async def test_paperclip_react_archives_source_card_to_paperless(
    ...
    from tests.e2e.matrix import wait_for_room_event
