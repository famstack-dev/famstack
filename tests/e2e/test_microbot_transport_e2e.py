...
The FakeClient tests in tests/unit/stacklets/test_microbot.py pin the
...
Run via the rig (brings up `messages`/Synapse, Simpsons family logged in):
    ...
    tests/e2e/stacktests pytest \
        tests/e2e/test_microbot_transport_e2e.py
"""
...
from tests.e2e.matrix import wait_for_room_event  # noqa: E402
