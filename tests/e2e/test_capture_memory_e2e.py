...
Run with `-s` to stream the BDD narration live:
    ...
    uv run --extra test pytest -s tests/e2e/test_capture_memory_e2e.py
"""

from __future__ import annotations

from tests.e2e.matrix import mxid

import asyncio

import pytest

from tests.e2e.forgejo import ForgejoError
from tests.e2e.openai_stub import stub_classify
...
# instance (server name comes from `tests/e2e/instance/stack.toml`).
