...
since it's just logging. Run with:
  uvx --with loguru --with matrix-nio pytest tests/unit/framework/test_microbot_cursor.py
"""
...
try:
    sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "stacklets" / "core" / "bot-runner"))
